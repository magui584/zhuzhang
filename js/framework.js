...
+function ($) { "use strict";
    ...
    var Request = function (element, handler, options) {
        ...
        function handleConfirmMessage(message) {
            ...
            if (message) return  layer.confirm(message, {icon: 0})
        }
        ...
        var requestOptions = {
            ...
            handleErrorMessage: function(message) {
                ...
                if (_event.isDefaultPrevented()) return
                if (message) {if(message =='您尚未登陆'){layer.alert(message,{btn:['立即登陆']},function(){$('#dlogin').trigger('click');});}else{layer.alert(message);}}
            },
